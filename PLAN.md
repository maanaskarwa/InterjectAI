...
5. The UI immediately shows a `QUICK` research job and a visible 12-second deadline.
...
- One real route: `QUICK`, with a deterministic 12-second deadline
...
- Remove the invocation prefix and create a `QUICK` job with a 12-second monotonic deadline.
